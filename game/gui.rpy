...
# For the need of change scale
define gui.scale_factor = 1
...
## 用于游戏内文本的字体。
define gui.text_font = "SJhuaxin_Regular.ttf"

## 用于角色名称的字体。
define gui.name_text_font = "SJhuaxin_Regular.ttf"

## 用于游戏外文本的字体。
define gui.interface_text_font = "SJhuaxin_Regular.ttf"
...
# TODO: should test this setting on 21:9 screen。it works well on 16:9(3840*2160)
define gui.main_menu_background = Movie(play="images/main_menu_background.webm",size=(1920,1080),loop=True)
...
## 存档位按钮。
define gui.slot_button_width = 656
define gui.slot_button_height = 154
# define gui.slot_button_borders = Borders(10, 10, 10, 10)
define gui.slot_button_text_size = 21
define gui.slot_button_text_xalign = 0.87
define gui.slot_button_text_idle_color = gui.idle_small_color
define gui.slot_button_text_selected_idle_color = gui.selected_color
define gui.slot_button_text_selected_hover_color = gui.hover_color

## 存档所用缩略图的宽度和高度。
define config.thumbnail_width = 268
