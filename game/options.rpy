...
define config.name = _("Medusa the Origin ~Lost Dream of the Deep")
...
define config.main_menu_music = "audio/Medusa.ogg"
...
define config.save_directory = "MedusaTheOrig-1630394782"
...
# 定义两个归档文件。
    ...
    build.classify('game/**.mpeg', 'archive')
